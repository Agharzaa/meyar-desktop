...
const css=fs.readFileSync(path.join(root,'src','styles-v181.css'),'utf8');
const main=fs.readFileSync(path.join(root,'main.js'),'utf8');

assert.match(html,/APP_VERSION='1\.16\.0'/);
assert.doesNotMatch(html,/href="\.\/styles-v170\.css"/,'Legacy v1.7 stylesheet must not be loaded with the new UI');
assert.match(html,/href="\.\/styles-v181\.css"/);
...
assert.match(css,/\.work-tabs\{height:27px!important/);
...
console.log('UI/data isolation v1.8.1: OK');
